...
<body>
  ...
  <div class="loginBox bg-primary">
    <div class="row align-items-center justify-content-center py-4 h-100">
      <div class="col-11 col-sm-8 col-md-6 col-lg-5 col-xl-3 bg-white shadow-lg rounded-8 p-5">
        <p class="text-center">
        ...
        <form action="<?php echo $BASE_URL; ?>/dbh/login_handler/login-handler.php" method="post">
          <h1 class="my-2  text-primary sig text-center display-3">User Log in</h1>
